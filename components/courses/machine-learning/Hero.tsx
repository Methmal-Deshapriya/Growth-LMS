...
const Hero = () => {
  return (
    <section className="w-screen   lg:w-[80vw] xl:w-[70vw] 2xl:w-[60vw]  py-20 px-6 md:px-12 lg:px-20  ">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col ">
          ...
          <div className="flex flex-col ">
            <h1 className="text-[38px] sm:text-[50px] md:text-[60px] lg:text-[70px] max-lg:text-center font-extrabold leading-[1.1] text-blue-600">
