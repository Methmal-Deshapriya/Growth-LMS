      ...
      <div className="z-10 md:w-[80vw] 2xl:w-[70vw] py-10 px-6 sm:mb-10 md:px-6 grid grid-cols-1  lg:grid-cols-2 items-center  gap-12">
        <div className="flex flex-col  lg:ml-10">
          <div className="flex max-lg:justify-center ">
            <h1 className="text-4xl text-nowrap sm:text-7xl md:text-[68px] lg:text-[53px] xl:text-[69px] 2xl:text-[80px] font-alt font-bold leading-tight max-lg:text-center text-foreground">
          ...
          <div className="w-full   flex max-lg:items-center max-lg:justify-center">
            <p className="text-lg max-lg:text-center font-poppins sm:text-xl 2xl:text-2xl text-foreground max-w-lg">
              Next level learning with recorded lessons, assignments & peer
              feedback,
              <span className=" text-foreground font-bold underline px-2 py-0.5 rounded ml-1">
                all in Sinhala
              </span>
            </p>
          </div>
