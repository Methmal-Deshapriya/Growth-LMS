      ...
      <div className="w-full 2xl:w-[70vw] max-w-[1300px]   px-6 md:px-12 lg:px-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground">
            Welcome to the <span className="text-primary">IT Industry</span>
          </h2>
        ...
        <div className=" grid grid-cols-1  lg:grid-cols-2 xl:grid-cols-3 gap-8 mt-16">
          {/* Card 1 */}
          <div className="bg-card shadow-lg hover:shadow-xl transition rounded-2xl p-8 border border-border">
        ...
        <div className="mt-20 bg-[#EEF2FF] border border-indigo-200 rounded-3xl p-10 text-center shadow-md">
          ...
          <p className="text-foreground text-lg max-w-2xl mx-auto">
            ...
            <span className="text-primary">the right guidance</span> and{" "}
            <span className="text-primary">consistent learning</span>
          </p>
        </div>
      </div>
    </section>
