...
export default function BootcampsPage() {
  ...
  return (
    <div className="w-full bg-card pb-24">
      {/* Page Hero */}
      <div className="bg-background border-b border-border py-16 md:py-24 px-6">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-muted-foreground font-medium">Discovering latest programs...</p>
          </div>
        ) : isError ? (
          <div className="bg-red-50 dark:bg-red-950/40 border border-red-100 dark:border-red-900/40 rounded-2xl p-12 text-center">
            <h2 className="text-2xl font-bold text-red-900 dark:text-red-300 mb-2">Oops! Something went wrong</h2>
          ...
          <div className="bg-background border border-dashed border-border rounded-3xl p-20 text-center">
            <Search className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-foreground mb-2">No bootcamps found</h2>
