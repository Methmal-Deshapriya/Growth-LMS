...
const statusClass: Record<CourseStatus, string> = {
  ...
  OPEN_ACTIVE: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-300",
  CLOSED_ACTIVE: "bg-blue-500/10 text-blue-700 dark:text-blue-300",
  COMPLETED: "bg-violet-500/10 text-violet-700 dark:text-violet-300",
  CANCELLED: "bg-red-500/10 text-red-700 dark:text-red-300",
  ARCHIVED: "bg-zinc-500/10 text-zinc-600 dark:text-zinc-300",
};
